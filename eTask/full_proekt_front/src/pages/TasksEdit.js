...
const TasksEdit = ({setTaskList, editList, setEditList, categories, setCategories}) => {
  ...
  const [categoryListCount, setCategoryListCount] = useState(!_.isEmpty(editList) ? editList.hours : [1])
    ...
    <Wrapper>
      <div className="content">
        <Formik
          ...
          initialValues={{
            ...editList,
            hours: !_.isEmpty(editList.hours) ? editList.hours : '',
            list: !_.isEmpty(editList.list) ? editList.list : '',
            min: !_.isEmpty(editList.min) ? editList.min : '',
            category: categories.filter(v => v.value === editList.category)[0]?.value,
          }}
        >
          {({
              handleSubmit,
                    ...
                    <div className="task_form">
                      <div className="task_form_content">
                        ...
                        <div className="task_form_item2">
                                  ...
                                  {categoryColors.map(v => {
                                    return (
                                      <span
                                        style={{
                                          background: v,
                                          width: editList.color === v ? '20px' : activeColor === v ? '20px' : '40px'
                                        }}
                                        onClick={() => {
                                          form.setFieldValue(field.name, v)
                                          setActiveColor(v)
                                          setEditList({...editList, color: v})
                                        }}
                                      />
                                    )
                                  })}
                          ...
                          <div className="task_form_item2_todolist">
                            <button>
                              <img src={format_list} alt=""/>
                              <h4>To do list</h4>
                            </button>
                          </div>
                        </div>
